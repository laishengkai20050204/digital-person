...
public class PersonApplicationConfiguration {
    ...
    /** Registers application capabilities after every regular configuration is known. */
    @Bean
    static BeanDefinitionRegistryPostProcessor personApplicationServiceRegistrar() {
